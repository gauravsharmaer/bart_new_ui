...
import { VoiceChatCardProps } from "../props/Props";
...
export default function VoiceChatCard({
  ...
  return (
    <div 
      ...
      className="fixed inset-0 flex items-center justify-center z-90 bg-black/30"
    >
      <div className="relative bg-white rounded-[32px] p-8 max-w-md w-[350px] h-[350px] shadow-lg flex flex-col items-center justify-center">
        ...
        {/* Text Container */}
        <p id="dialog-title" className="text-center text-[#4A4A4A] text-2xl font-medium">
          {text || "Listening..."}
        </p>
      </div>
    </div>
