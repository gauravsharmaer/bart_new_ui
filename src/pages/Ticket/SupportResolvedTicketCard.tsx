...
const SupportResolvedTicketCard = () => {
    ...
    <div className="flex flex-wrap justify-around gap-3 h-[500px] overflow-y-auto">
      {ticketData.map((ticket) => (
        <Link
          ...
          target="_blank"
          key={ticket.id}
          className="w-full max-w-md transition-transform hover:scale-[1.02] hover:shadow-lg dark:hover:shadow-[#1a1b1e]"
        >
...
export default SupportResolvedTicketCard;
